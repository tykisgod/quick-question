...
The installer now copies both shell and Python runtime helpers and creates a starter `qq-policy.json` in the Unity project if one does not already exist.
