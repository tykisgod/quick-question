...
⚡ **20 Slash Commands** — test, commit, review, explain, dependency analysis, and more<br>
...
⚡ **20 個のスラッシュコマンド** — テスト、コミット、レビュー、解説、依存分析など<br>
...
⚡ **20개 슬래시 커맨드** — 테스트, 커밋, 리뷰, 설명, 의존성 분석 등<br>
